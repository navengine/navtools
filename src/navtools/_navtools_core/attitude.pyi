...
@typing.overload
def dcm2euler(
    e: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
...
@typing.overload
def dcm2euler(
    C: numpy.ndarray[numpy.float64[3, 3], numpy.ndarray.flags.f_contiguous], IsNed: bool = True
...
@typing.overload
def dcm2quat(
    q: numpy.ndarray[numpy.float64[4, 1], numpy.ndarray.flags.writeable],
    C: numpy.ndarray[numpy.float64[3, 3], numpy.ndarray.flags.f_contiguous],
) -> None:
    """
    dcm2quat
...
def euler2dcm(
    ...
    e: numpy.ndarray[numpy.float64[3, 1]],
    IsNed: bool = True,
) -> None:
    """
    euler2dcm
...
@typing.overload
def euler2dcm(
    e: numpy.ndarray[numpy.float64[3, 1]], IsNed: bool = True
...
@typing.overload
def euler2quat(
    q: numpy.ndarray[numpy.float64[3, 1]], IsNed: bool = True
) -> numpy.ndarray[numpy.float64[4, 1]]:
    """
    euler2quat
    ==========
...
def quat2dcm(
    ...
    C: numpy.ndarray[numpy.float64[4, 1]],
) -> None:
    """
    quat2dcm
    ========
...
@typing.overload
def quat2euler(
    q: numpy.ndarray[numpy.float64[4, 1]], IsNed: bool = True
) -> numpy.ndarray[numpy.float64[3, 1]]:
    """
    quat2euler
    ==========
