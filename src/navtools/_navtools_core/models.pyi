...
@typing.overload
def CoriolisRate(
    coriolis: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
...
@typing.overload
def EarthRate(
    w_ie_n: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
    phi: float,
    IsNed: bool = True,
) -> None:
    """
...
@typing.overload
def EarthRate(
    phi: numpy.ndarray[numpy.float64[3, 1]],
    v_nb_e: numpy.ndarray[numpy.float64[3, 1]],
    IsNed: bool = True,
) -> numpy.ndarray[numpy.float64[3, 1]]:
    """
...
def EcefGravity(
    g: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
    gamma: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
...
@typing.overload
def LocalGravity(
    lla: numpy.ndarray[numpy.float64[3, 1]], IsNed: bool = True
) -> numpy.ndarray[numpy.float64[3, 1]]:
    """
    LocalGravity
    ============
...
def TransportRate(
    w_en_n: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
    phi: numpy.ndarray[numpy.float64[3, 1]],
    v_nb_e: numpy.ndarray[numpy.float64[3, 1]],
    IsNed: bool = True,
) -> None:
